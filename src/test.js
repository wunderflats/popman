...
describe('popman', function () {
  ...
  it('positions popover to the left if it would otherwise overflow left of viewport')
  it('positions popover to the right if it would otherwise overflow right of viewport')
  it('positions popover to the top if it would otherwise overflow top of viewport')
  it('positions popover to the bottom if it would otherwise overflow bottom of viewport')
